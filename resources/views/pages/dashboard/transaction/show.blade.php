    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="shadow overflow-hidden sm:rounded-md">
                <h2 class="font-semibold text-lg text-gray-800 leading-tight mb-3 mt-3">Transaction Details</h2>
            ...
            <h2 class="font-semibold text-lg text-gray-800 leading-tight mb-3 mt-3">Transaction Items</h2>
