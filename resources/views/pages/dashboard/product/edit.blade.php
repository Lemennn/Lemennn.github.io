                ...
                <form action="{{ route('dashboard.product.update', $item->id) }}" class="w-full" method="post" enctype="multipart/form-data">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                       <div class="w-full px-3">
                        ...
                        <input type="text" placeholder="{{ $item->name }}" id="gripd-last-name" value="{{ $item->name }}" name="name" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bd-white focus:border-gray-500">
                       </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                       <div class="w-full px-3">
                        ...
                        <input type="text" placeholder="{{ $item->price }}" id="gripd-last-name" value="{{  $item->price }}" name="price" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bd-white focus:border-gray-500">
                       </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
                       <div class="w-full px-3">
                    ...
                    <div class="flex flex-wrap -mx-3 mb-6">
                       <div class="w-full px-3">
                        ...
                        <input type="text" placeholder="{{ $item->description }}" id="gripd-last-name" value="{{ $item->description }}" name="description" class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bd-white focus:border-gray-500">
                       </div>
                    </div>
                    <div class="flex flex-wrap -mx-3 mb-6">
