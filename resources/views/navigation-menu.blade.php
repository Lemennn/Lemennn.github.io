            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard.index') }}">
                        <img src="logobgm.png" alt="" style="height: 50px">
                    </a>
                </div>
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    {{-- <x-jet-nav-link href="{{ route('dashboard.product.gallery.index') }}" :active="request()->routeIs('dashboard.product.gallery.index    ')">
                        {{ __('Picture') }}
                    </x-jet-nav-link> --}}
                </div>
            </div>
